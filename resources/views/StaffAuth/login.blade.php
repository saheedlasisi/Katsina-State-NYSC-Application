...
<head>
    ...
    <title>{{ config('app.name', 'KatsinaStateNysc') }} | Staff Login</title>
                  ...
                  <div class="col-md-12 col-lg-6 login-right shadow" style="background: lightgreen; border-radius: 20px; margin-bottom: 20px;">
                    ...
                    <form action="{{ route('staff.login') }}" method="POST">
                      ...
                      <div class="text-right">
                        <a class="forgot-link" href="{{route('staff.password.request')}}">Forgot Password ?</a>
                      </div>
