...
<head>
    ...
    <title>{{ config('app.name', 'KatsinaStateNysc') }} | SaedMaster Reset Password</title>
                ...
                <div class="row align-items-center justify-content-center" >
                  ...
                  <div class="col-md-12 col-lg-6 login-right" style="background: lightgreen; border-radius: 20px;">
                    <div class="login-header">
                      <h3 style="color: #fff;">SaedMaster <span>Send Password Reset Link</span></h3>
                    </div>
                     @if (session('status'))
                    ...
                    @endif
                    <form action="{{ route('saedmaster.password.email') }}" method="POST">
                      {{ csrf_field() }}
                      ...
                      <div class="text-right">
                        <a class="forgot-link" href="{{route('saedmaster.login')}}">Back to Login</a>
                      </div>
