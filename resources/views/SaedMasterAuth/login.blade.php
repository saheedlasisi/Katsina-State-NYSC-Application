...
<head>
    ...
    <title>{{ config('app.name', 'KatsinaStateNysc') }} | SaedMaster Login</title>
                ...
                <div class="row align-items-center justify-content-center">
                  ...
                  <div class="col-md-12 col-lg-6 login-right shadow" style="background: lightgreen; border-radius: 20px; margin-bottom: 20px;">
                    <div class="login-header">
                      <h3>Saed Master <span>Login</span></h3>
                    </div>
                    <form action="{{ route('saedmaster.login') }}" method="POST">
                      {{ csrf_field() }}
                      ...
                      <div class="text-right">
                        <a class="forgot-link" href="{{route('saedmaster.password.request')}}">Forgot Password ?</a>
                      </div>
