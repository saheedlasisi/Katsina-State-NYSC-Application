...
<!-- Page Content -->
      ...
      <div class="row">
       ...
       <div class="col-md-12">
        <input type="file"  name="edit_upload_image" id="edit_upload_image" accept="image/jpeg, image/png, image/gif," required >
        <button class="btn btn-success btn-block btn-lg" id="edit_upload_crop_image">Upload</button>
        </div>
</div>
