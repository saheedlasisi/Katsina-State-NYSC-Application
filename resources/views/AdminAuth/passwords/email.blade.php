...
<head>
    ...
    <title>{{ config('app.name', 'KatsinaStateNysc') }} | Admin Reset Password</title>
                ...
                <div class="row align-items-center justify-content-center" >
                  ...
                  <div class="col-md-12 col-lg-6 login-right" style="background: lightgreen; border-radius: 20px;">
                    <div class="login-header">
                      <h3 style="color: #fff;">Admin <span>Send Password Reset Link</span></h3>
                    </div>
                     @if (session('status'))
                    ...
                    <form action="{{ route('admin.password.email') }}" method="POST">
                      ...
                      <div class="text-right">
                        <a class="forgot-link" href="{{route('admin.login')}}">Back to Login</a>
                      </div>
