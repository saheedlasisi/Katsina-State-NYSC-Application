									...
									<div class="doctor-widget">
										<div class="doc-info-left">
											...
											<div class="doc-info-cont">
												<h2 class="doc-name mb-2" style="font-size: 30px;">{{$product->product_name}}</h2>
											...
											<span class="d-inline-block average-rating">({{$product->love}})</span>
												...
												<div class="col-lg-6 text-right">
													<a href="/deleteproduct/{{$product->shop_product_id}}/{{$product->shop_id}}" class="cart-icon confirmproductdeletebtn"><i class="fas fa-trash" style="color: red; font-size: 50px;"></i></a>
												</div>
											</div>

												<p><a href="/editproduct/{{$product->product_name}}/{{$product->shop_product_id}}" class="btn btn-success btn-sm" style="font-weight: 700;"><i class="fas fa-pen" style="color: #fff;"></i> Update Product</a></p>
